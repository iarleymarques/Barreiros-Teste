...
export default function Historia({ isLoggedIn, onOpenLogin }) {
  ...
  return (
    <section id="historia">
      ...
      {/* ================================================================= */}
      {/* FUNDO COM FOTO — cobre tanto o hero quanto a seção de features     */}
      {/* ================================================================= */}
      <div
        className="relative"
        style={{
      ...
      >
        {/* Overlay escuro unificado para contraste e legibilidade */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[540px] items-stretch">
                ...
                {isLoggedIn ? (
                  <div>
                    <button
                      ...
                      className="inline-flex items-center gap-2 px-6 py-3 bg-white hover:bg-slate-100 text-[#0D0D0D] text-sm font-bold tracking-wide transition-colors duration-150 cursor-pointer"
                    >
                  ...
                  <div>
                    <button
                      onClick={onOpenLogin}
                      className="inline-flex items-center gap-2 px-6 py-3 bg-red-700 hover:bg-red-800 text-white text-sm font-bold tracking-wide transition-colors duration-150 cursor-pointer shadow-lg shadow-red-950/40"
                    >
              ...
              <div className="hidden lg:flex items-center justify-center border-l border-white/10 py-16 px-12">
                {/* Documento estilizado — ilustração tipográfica */}
                <div className="w-full max-w-sm bg-white border border-slate-200 shadow-2xl rounded-sm overflow-hidden">
                  ...
                  <div className="px-5 py-5 space-y-4">
                    ...
                    <div className="flex items-center justify-between pt-1">
                      <div className="text-[9px] text-slate-400 font-mono">Protocolo #IB-2026-XXXX</div>
                      <div className="text-[9px] text-slate-400 font-mono">Cascavel · CE</div>
                    </div>
                  </div>
                </div>
              </div>
        ...
        {/* ================================================================= */}
        {/* O QUE VOCÊ PODE FAZER AQUI — 4 blocos funcionais (sobre a foto)   */}
        {/* ================================================================= */}
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-16">
          ...
          <div className="mb-8">
            ...
            <div className="w-8 h-0.5 bg-red-600 mt-2"></div>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 divide-y sm:divide-y-0 sm:divide-x divide-white/10 border border-white/10 bg-slate-950/40 backdrop-blur-xs">
            {features.map((f, idx) => {
              const Icon = f.icon;
              return (
                <div key={idx} className="px-6 py-7 hover:bg-white/5 transition-colors duration-150">
                  <Icon className="w-5 h-5 text-red-500 mb-4 stroke-[1.5]" />
